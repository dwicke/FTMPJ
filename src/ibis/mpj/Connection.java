/* $Id: Connection.java 11526 2009-11-18 09:37:09Z ceriel $ */
...
public class Connection {
    ...
    protected void setupReceivePort() {
        ...
        try {
            ...
            // I made following thing with the upcall
            //this.receiver = MPJ.ibis.createReceivePort(portType, portString, new DrewUpcall());
            this.receiver.enableConnections();
            // DREW must enable upcalls
            //this.receiver.enableMessageUpcalls();
        } catch (Exception e) {
