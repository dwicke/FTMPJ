/* $Id: MPJ.java 9795 2008-11-12 09:37:31Z ceriel $ */
...
public class MPJ {
    ...
    // DREW was private made it a public 
    ...
    public static boolean isConnectedTo(int id)
    {
        return connectionTable.isConnected(id);
    }
    /**
     * Initialize MPJ.
     * 
    ...
    public static void init(String[] args) throws MPJException {
        try {
            ...
            // I added PortType.CONNECTION_UPCALLS
            // removed PortType.RECEIVE_EXPLICIT and replaced with PortType.RECEIVE_AUTO_UPCALLS
            ...
            // I am printing this
            System.err.println("ibis version is " + ibis.getVersion());
            ...
            System.err.println(registry.getClass().toString());
    ...
    protected static void setupConnections() throws Exception, MPJException
    {
        connectionTable = new ConnectionTable();
            ...
            for (int i = 0; i < MPJ.regEvtHandler.nInstances; i++) {
                 ...
                 */
                Connection con = MPJ.connectionTable
                        .getUntestedConnection(MPJ.regEvtHandler.identifiers[i]);
                con.setupSendPort();
    ...
    public static void finish() throws MPJException {
        ...
        try {
            ...
            for (int i = 0; i < MPJ.regEvtHandler.nInstances; i++) {
                ...
                Connection con = MPJ.connectionTable.getUntestedConnection(mpjId);
                con.close();
            }
